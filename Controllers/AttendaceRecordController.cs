...
namespace AttendanceProject.Controllers
{
    public class AttendaceRecordController : Controller
    {
        ...
        {
            ViewData["Id"] = new SelectList(_context.Attendence, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,IsPresent")] AttendaceRecordModel attendaceRecordModel)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Attendence, "Id", "Id", attendaceRecordModel.Id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,IsPresent")] AttendaceRecordModel attendaceRecordModel)
        {
